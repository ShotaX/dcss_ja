...
bool player_angers_monster(monster* mon)
{
    ...
    if (why && mon->wont_attack())
    {
        ...
        if (you.can_see(mon))
        {
            ...
            case DID_UNHOLY:
            case DID_NECROMANCY:
                mprf(jtrans("%s is enraged by your holy aura!").c_str(), mname.c_str());
                break;
            case DID_CORPSE_VIOLATION:
                mprf(jtrans("%s is revulsed by your support of nature!").c_str(), mname.c_str());
                break;
            case DID_HOLY:
                mprf(jtrans("%s is enraged by your evilness!").c_str(), mname.c_str());
                break;
            case DID_UNCLEAN:
            case DID_CHAOS:
                mprf(jtrans("%s is enraged by your lawfulness!").c_str(), mname.c_str());
                break;
            case DID_SPELL_CASTING:
                mprf(jtrans("%s is enraged by your magic-hating god!").c_str(), mname.c_str());
                break;
            default:
                mprf(jtrans("%s is enraged by a buggy thing about you!").c_str(), mname.c_str());
                break;
            }
        }
