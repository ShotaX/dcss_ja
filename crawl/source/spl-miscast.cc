...
string MiscastEffect::get_default_cause(bool attribute_to_user) const
{
    ...
    if (source == NON_MONSTER)
    {
        ...
        str += jtrans(spell_title(spell)).c_str();
        return str;
    }
    ...
    if (attribute_to_user)
    {
        return (string(you.can_see(act_source) ? act_source->name(DESC_A)
                                               : "something")
                + " miscasting " + jtrans(spell_title(spell)).c_str());
    }
    else
        return string("miscast of ") + jtrans(spell_title(spell)).c_str();
}
...
void MiscastEffect::do_miscast()
{
    ...
    else
    {
        ...
        mprf(MSGCH_DIAGNOSTICS, "'%s' miscast power: %d",
             spell != SPELL_NO_SPELL ? jtrans(spell_title(spell)).c_str()
...
void MiscastEffect::_conjuration(int severity)
{
    ...
    case 0:         // just a harmless message
        ...
        {
        case 0:
            you_msg      = jtrans("Sparks fly from your @hands@!");
            mon_msg_seen = "Sparks fly from @the_monster@'s @hands@!";
            break;
        case 1:
            you_msg      = jtrans("The air around you crackles with energy!");
            mon_msg_seen = "The air around @the_monster@ crackles "
                           "with energy!";
            break;
        case 2:
            you_msg      = jtrans("Wisps of smoke drift from your @hands@.");
            mon_msg_seen = "Wisps of smoke drift from @the_monster@'s "
                           "@hands@.";
            break;
        case 3:
            you_msg = jtrans("You feel a strange surge of energy!");
            // Monster messages needed.
            break;
        case 4:
            you_msg      = jtrans("You are momentarily dazzled by a flash of light!");
            mon_msg_seen = "@The_monster@ emits a flash of light!";
            break;
        case 5:
            you_msg      = jtrans("Strange energies run through your body.");
            mon_msg_seen = "@The_monster@ glows " + weird_glowing_colour() +
                           " for a moment.";
            break;
        case 6:
            you_msg      = jtrans("Your skin tingles.");
            mon_msg_seen = "@The_monster@ twitches.";
            break;
        case 7:
            you_msg      = jtrans("Your skin glows momentarily.");
        ...
        case 9:
            if (you.can_smell())
                all_msg = jtrans("You smell something strange.");
            else if (you.species == SP_MUMMY)
                you_msg = jtrans("Your bandages flutter.");
            break;
        case 10:
        {
            // Player only (for now).
    ...
    case 1:         // a bit less harmless stuff
        ...
        {
        case 0:
            you_msg        = jtrans("Smoke pours from your @hands@!");
            ...
            break;
        case 1:
            you_msg      = jtrans("A wave of violent energy washes through your body!");
    ...
    case 2:         // rather less harmless stuff
        ...
        {
        case 0:
            you_msg      = jtrans("Energy rips through your body!");
            mon_msg_seen = "@The_monster@ jerks violently!";
            _ouch(9 + random2avg(17, 2));
            break;
        case 1:
            you_msg        = jtrans("You are caught in a violent explosion!");
    ...
    case 3:         // considerably less harmless stuff
        ...
        {
        case 0:
            you_msg      = jtrans("You are blasted with magical energy!");
            mon_msg_seen = "@The_monster@ is blasted with magical energy!";
            // No message for invis monsters?
            _ouch(12 + random2avg(29, 2));
            break;
        case 1:
            all_msg = jtrans("There is a sudden explosion of magical energy!");
...
void MiscastEffect::_enchantment(int severity)
{
    ...
    case 0:         // harmless messages only
        ...
        case 1:
            ...
            break;
        case 2:
            you_msg        = jtrans("Multicoloured lights dance before your eyes!");
        ...
        case 3:
            ...
            break;
        case 4:
            you_msg      = jtrans("Waves of light ripple over your body.");
        ...
        case 9:
            ...
            {
                all_msg        = jtrans("You hear something strange.");
                msg_ch         = MSGCH_SOUND;
                sound_loudness = 2;
                return;
            }
                ...
                if (you.species == SP_OCTOPODE)
                    you_msg = jtrans("Your beak vibrates slightly."); // the only hard part
                else
                    you_msg = jtrans("Your skull vibrates slightly.");
            break;
        }
        do_msg();
        break;
    ...
    case 3:         // potentially lethal
        ...
        case 3:
            ...
            mpr(jtrans("You sense an overwhelmingly malignant aura!"));
            break;
        }
        break;
    }
...
void MiscastEffect::_translocation(int severity)
{
    ...
    case 0:         // harmless messages only
        ...
        {
        case 0:
            you_msg      = jtrans("Space warps around you.");
        ...
        case 1:
            ...
            break;
        case 2:
            you_msg      = jtrans("You feel a wrenching sensation.");
        ...
        case 3:
            ...
            break;
        case 4:
            you_msg      = jtrans("You spin around.");
        ...
        case 6:
            ...
            break;
        case 7:
            you_msg      = jtrans("The world appears momentarily distorted!");
        ...
        case 8:
            ...
            break;
        case 9:
            you_msg      = jtrans("You feel uncomfortable.");
    ...
    case 1:         // mostly harmless
        ...
        case 1:
        case 2:
            you_msg        = jtrans("You are caught in a localised field of spatial distortion.");
        ...
        case 3:
        case 4:
            you_msg        = jtrans("Space bends around you!");
        ...
        case 5:
            if (_create_monster(MONS_SPATIAL_VORTEX, 3))
                all_msg = jtrans("Space twists in upon itself!");
            do_msg();
            break;
        }
        break;
    ...
    reroll_2:
        ...
        case 1:
        case 2:
            you_msg        = jtrans("You are caught in a strong localised spatial distortion.");
    ...
    reroll_3:
        ...
        {
        case 0:
            you_msg        = jtrans("You are caught in an extremely strong localised spatial distortion!");
            ...
            break;
        case 1:
            you_msg        = jtrans("Space warps crazily around you!");
...
void MiscastEffect::_summoning(int severity)
{
    ...
    case 0:         // harmless messages only
        ...
        {
        case 0:
            you_msg      = jtrans("Shadowy shapes form in the air around you, then vanish.");
        ...
        case 1:
            if (neither_end_silenced())
            {
                all_msg        = jtrans("You hear strange voices.");
                msg_ch         = MSGCH_SOUND;
                sound_loudness = 2;
            }
            else if (target->is_player())
                you_msg = jtrans("You feel momentarily dizzy.");
            break;
        case 2:
            you_msg = jtrans("Your head hurts.");
            // Monster messages needed.
            break;
        case 3:
            you_msg = jtrans("You feel a strange surge of energy!");
            ...
            break;
        case 4:
            you_msg = jtrans("Your brain hurts!");
            // Monster messages needed.
            break;
        case 5:
            you_msg      = jtrans("Strange energies run through your body.");
        ...
        case 9:
            if (neither_end_silenced())
            {
                you_msg        = jtrans("Distant voices call out to you!");
    ...
    case 1:         // a little bad
        ...
        case 1:
        case 2:
            you_msg        = jtrans("You are caught in a localised spatial distortion.");
        ...
        case 5:
            if (_create_monster(summon_any_demon(RANDOM_DEMON_LESSER), 5, true))
                all_msg = jtrans("Something appears in a flash of light!");
            do_msg();
            break;
        }
        break;
    ...
    case 2:         // more bad
        ...
        case 2:
            if (_create_monster(summon_any_demon(RANDOM_DEMON_COMMON), 5, true))
                all_msg = jtrans("Something forms from out of thin air!");
            do_msg();
            break;
        ...
        case 5:
        {
            ...
            {
                you_msg        = jtrans("A chorus of chattering voices calls out to you!");
        ...
        while (reroll)
        {
            ...
            case 1:
                if (_create_monster(summon_any_demon(RANDOM_DEMON_GREATER), 0, true))
                    all_msg = jtrans("You sense a hostile presence.");
                do_msg();
                reroll = false;
                break;
            ...
            case 2:
            {
                ...
                if (success)
                {
                    you_msg = jtrans("Something turns its malign attention towards you...");
...
void MiscastEffect::_divination_you(int severity)
{
    ...
    case 0:         // just a harmless message
        ...
        case 1:
            if (!silenced(you.pos()))
            {
                mpr(jtrans("You hear strange voices."), MSGCH_SOUND);
                noisy(2, you.pos());
            }
            else
    ...
    case 2:         // even more annoying things
        ...
        case 1:
            ...
            if (you.magic_points > 0 || you.species == SP_DJINNI)
            {
                ...
                mpr(jtrans("You suddenly feel drained of magical energy!"), MSGCH_WARN);
            }
            break;
        }
...
void MiscastEffect::_necromancy(int severity)
{
        ...
        && !player_under_penance() && you.piety >= piety_breakpoint(1))
    {
        ...
        else if (death_curse)
        {
            if (coinflip())
            {
                simple_god_message(jtrans("averts the curse.").c_str());
                return;
            }
            else
            {
                simple_god_message(jtrans("partially averts the curse.").c_str());
    ...
    case 0:
        ...
        case 0:
            if (you.can_smell())
                all_msg = jtrans("You smell decay.");
            else if (you.species == SP_MUMMY)
                you_msg = jtrans("Your bandages flutter.");
            break;
        case 1:
            if (neither_end_silenced())
            {
                all_msg        = jtrans("You hear strange and distant voices.");
                msg_ch         = MSGCH_SOUND;
                sound_loudness = 3;
            }
            else if (target->is_player())
                you_msg = jtrans("You feel homesick.");
            break;
        case 2:
            you_msg = jtrans("Pain shoots through your body.");
            mon_msg_seen = "@The_monster@ twitches violently.";
            break;
        case 3:
            if (you.species == SP_OCTOPODE)
                you_msg = jtrans("You feel numb.");
            else
                you_msg = jtrans("Your bones ache.");
            mon_msg_seen = "@The_monster@ pauses, visibly distraught.";
            break;
        case 4:
            you_msg      = jtrans("The world around you seems to dim momentarily.");
        ...
        case 5:
            ...
            break;
        case 6:
            you_msg      = jtrans("You shiver with cold.");
            mon_msg_seen = "@The_monster@ shivers with cold.";
            break;
        case 7:
            you_msg        = jtrans("You sense a malignant aura.");
        ...
        case 8:
            ...
            break;
        case 9:
            you_msg      = jtrans("You feel very uncomfortable.");
    ...
    case 1:         // a bit nasty
        ...
        case 0:
            ...
            {
                you_msg      = jtrans("You feel weird for a moment.");
            ...
            break;
        case 1:
            you_msg      = jtrans("You feel horribly lethargic.");
    ...
    case 2:         // much nastier
        ...
        case 0:
        {
            ...
            if (success)
            {
                you_msg        = jtrans("Flickering shadows surround you.");
        ...
        case 1:
            you_msg      = jtrans("You are engulfed in negative energy!");
        ...
        case 2:
            ...
            {
                you_msg      = jtrans("You convulse helplessly as pain tears through your body!");
    ...
    case 3:         // even nastier
        ...
        case 0:
            ...
            {
                you_msg      = jtrans("Something just walked over your grave. No, really!");
        ...
        case 2:
            ...
            {
                you_msg        = jtrans("Something reaches out for you...");
        ...
        case 3:
            ...
            {
                you_msg        = jtrans("Death has come for you...");
...
void MiscastEffect::_transmutation(int severity)
{
    ...
    case 0:         // just a harmless message
        ...
        case 10:
        {
            ...
            bool plural;
            string hair = _hair_str(target, plural);
            you_msg = make_stringf(jtrans("Your %s momentarily turn into snakes!").c_str(),
                                   hair.c_str());
        }
        }
        do_msg();
    ...
    case 1:         // slightly annoying
        ...
        {
        case 0:
            you_msg      = jtrans("Your body is twisted painfully.");
    ...
    case 2:         // much more annoying
        ...
        case 0:
            if (target->polymorph(0)) // short duration
                break;
        case 1:
            you_msg      = jtrans("Your body is twisted very painfully!");
    ...
    case 3:         // even nastier
        ...
        {
        case 0:
            you_msg = jtrans("Your body is flooded with distortional energies!");
        ...
        case 1:
            ...
            if (target->is_player())
            {
                you_msg = jtrans("You feel very strange.");
        ...
        case 2:
            if (target->is_player())
            {
                ...
                you_msg = jtrans("Your body is distorted in a weirdly horrible way!");
...
void MiscastEffect::_fire(int severity)
{
    ...
    case 0:         // just a harmless message
        ...
        case 0:
            ...
            break;
        case 1:
            you_msg      = jtrans("The air around you burns with energy!");
        ...
        case 4:
            if (you.can_smell())
                all_msg = jtrans("You smell smoke.");
            else if (you.species == SP_MUMMY)
                you_msg = jtrans("Your bandages flutter.");
            break;
        case 5:
            you_msg = jtrans("Heat runs through your body.");
            // Monster messages needed.
            break;
        case 6:
            you_msg = jtrans("You feel uncomfortably hot.");
            // Monster messages needed.
            break;
        case 7:
            you_msg      = jtrans("Lukewarm flames ripple over your body.");
        ...
        case 9:
            if (neither_end_silenced())
            {
                all_msg        = jtrans("You hear a sizzling sound.");
                msg_ch         = MSGCH_SOUND;
                sound_loudness = 2;
            }
            else if (target->is_player())
                you_msg = jtrans("You feel like you have heartburn.");
            break;
        }
        do_msg();
        break;
    ...
    case 1:         // a bit less harmless stuff
        ...
        case 1:
            you_msg      = jtrans("Flames sear your flesh.");
    ...
    case 2:         // rather less harmless stuff
        ...
        {
        case 0:
            you_msg        = jtrans("You are blasted with fire.");
        ...
        case 1:
            you_msg        = jtrans("You are caught in a fiery explosion!");
    ...
    case 3:         // considerably less harmless stuff
        ...
        {
        case 0:
            you_msg        = jtrans("You are blasted with searing flames!");
        ...
        case 2:
        {
            you_msg      = jtrans("You are covered in liquid flames!");
...
void MiscastEffect::_ice(int severity)
{
    ...
    case 0:         // just a harmless message
        ...
        case 0:
            ...
            break;
        case 1:
            you_msg = jtrans("A chill runs through your body.");
            // Monster messages needed.
            break;
        case 2:
            you_msg        = jtrans("Wisps of condensation drift from your @hands@.");
        ...
        case 3:
            ...
            break;
        case 4:
            you_msg      = jtrans("Your @hands@ feel numb with cold.");
            // Monster messages needed.
            break;
        case 5:
            you_msg = jtrans("A chill runs through your body.");
            ...
            break;
        case 6:
            you_msg = jtrans("You feel uncomfortably cold.");
            // Monster messages needed.
            break;
        case 7:
            you_msg      = jtrans("Frost covers your body.");
        ...
        case 9:
            if (neither_end_silenced())
            {
                all_msg        = jtrans("You hear a crackling sound.");
                msg_ch         = MSGCH_SOUND;
                sound_loudness = 2;
            }
            else if (target->is_player())
                you_msg = jtrans("A snowflake lands on your nose.");
            break;
        case 10:
            if (feat_is_water(feat))
                all_msg  = jtrans("A thin layer of ice forms on") + feat_name;
            else
                all_msg  = jtrans("Frost spreads across") + feat_name;
            break;
        }
        do_msg();
        break;
    ...
    case 1:         // a bit less harmless stuff
        ...
        case 0:
            ...
            break;
        case 1:
            you_msg      = jtrans("You are covered in a thin layer of ice.");
    ...
    case 2:         // rather less harmless stuff
        ...
        {
        case 0:
            you_msg = jtrans("Heat is drained from your body.");
            // Monster messages needed.
        ...
        case 1:
            you_msg        = jtrans("You are caught in an explosion of ice and frost!");
    ...
    case 3:         // less harmless stuff
        ...
        {
        case 0:
            you_msg      = jtrans("You are blasted with ice!");
            ...
            break;
        case 1:
            you_msg        = jtrans("Freezing gasses pour from your @hands@!");
...
void MiscastEffect::_earth(int severity)
{
    ...
    case 1:
        ...
        {
        case 0:
            you_msg = jtrans("You feel earthy.");
            // Monster messages needed.
            break;
        case 1:
            you_msg        = jtrans("You are showered with tiny particles of grit.");
            ...
            break;
        case 2:
            you_msg        = jtrans("Sand pours from your @hands@.");
            mon_msg_seen   = "Sand pours from @the_monster@'s @hands@.";
            mon_msg_unseen = "Sand pours from out of thin air.";
            break;
        case 3:
            you_msg = jtrans("You feel a surge of energy from the ground.");
            // Monster messages needed.
            break;
        case 4:
            if (neither_end_silenced())
            {
                all_msg        = jtrans("You hear a distant rumble.");
                msg_ch         = MSGCH_SOUND;
                sound_loudness = 2;
            }
            else if (target->is_player())
                you_msg = jtrans("You sympathise with the stones.");
            break;
        case 5:
            you_msg = jtrans("You feel gritty.");
            // Monster messages needed.
            break;
        case 6:
            you_msg      = jtrans("You feel momentarily lethargic.");
            mon_msg_seen = "@The_monster@ looks momentarily listless.";
            break;
        case 7:
            you_msg        = jtrans("Motes of dust swirl before your eyes.");
        ...
        case 10:
            ...
            {
                you_msg      = jtrans("You briefly vibrate.");
                mon_msg_seen = "@The_monster@ briefly vibrates.";
            }
            else
            {
                you_msg      = jtrans("You momentarily stiffen.");
                mon_msg_seen = "@The_monster@ momentarily stiffens.";
            }
            break;
        case 11:
            all_msg = jtrans("The floor vibrates.");
            break;
        case 12:
            all_msg = jtrans("The floor shifts beneath you alarmingly!");
            break;
        }
        do_msg();
        break;
    ...
    case 3:         // less harmless stuff
        ...
        {
        case 0:
            you_msg        = jtrans("You are caught in an explosion of flying shrapnel!");
            mon_msg_seen   = "@The_monster@ is caught in an explosion of "
                             "flying shrapnel!";
...
void MiscastEffect::_air(int severity)
{
    ...
    case 0:         // just a harmless message
        ...
        {
        case 0:
            you_msg      = jtrans("You feel momentarily weightless.");
            mon_msg_seen = "@The_monster@ bobs in the air for a moment.";
            break;
        case 1:
            you_msg      = jtrans("Wisps of vapour drift from your @hands@.");
        ...
        case 2:
        {
            ...
            if (pluralised)
            {
                you_msg      = jtrans("Sparks of electricity dance between your @hands@.");
                mon_msg_seen = "Sparks of electricity dance between "
                               "@the_monster@'s @hands@.";
            }
            else
            {
                you_msg      = jtrans("Sparks of electricity dance over your @hand@.");
        ...
        case 3:
            you_msg      = jtrans("You are blasted with air!");
            mon_msg_seen = "@The_monster@ is blasted with air!";
            break;
        case 4:
            if (neither_end_silenced())
            {
                all_msg        = jtrans("You hear a whooshing sound.");
                msg_ch         = MSGCH_SOUND;
                sound_loudness = 2;
            }
            else if (you.can_smell())
                all_msg = jtrans("You smell ozone.");
            else if (you.species == SP_MUMMY)
                you_msg = jtrans("Your bandages flutter.");
            break;
        case 5:
        ...
        case 6:
            if (neither_end_silenced())
            {
                ...
                all_msg = jtrans("You smell something musty.");
            else if (you.species == SP_MUMMY)
                you_msg = jtrans("Your bandages flutter.");
            break;
        case 7:
            you_msg      = jtrans("There is a short, sharp shower of sparks.");
            mon_msg_seen = "@The_monster@ is briefly showered in sparks.";
            break;
        case 8:
            if (silenced(you.pos()))
            {
               you_msg        = jtrans("The wind whips around you!");
               mon_msg_seen   = "The wind whips around @the_monster@!";
               mon_msg_unseen = "The wind whips!";
            }
            else
            {
               you_msg        = jtrans("The wind howls around you!");
               mon_msg_seen   = "The wind howls around @the_monster@!";
               mon_msg_unseen = "The wind howls!";
            }
            break;
        case 9:
            you_msg = jtrans("Ouch! You gave yourself an electric shock.");
            // Monster messages needed.
            break;
        case 10:
            you_msg = jtrans("You feel a strange surge of energy!");
            ...
            break;
        case 11:
            you_msg = jtrans("You feel electric!");
            // Monster messages needed.
            break;
        case 12:
        {
            ...
            bool plural;
            string hair = _hair_str(target, plural);
            you_msg = make_stringf(jtrans("Your %s stand on end.").c_str(), hair.c_str());
            break;
        }
        }
        do_msg();
    ...
    case 1:         // rather less harmless stuff
        ...
        {
        case 0:
            you_msg        = jtrans("Electricity courses through your body.");
            ...
            break;
        case 1:
            you_msg        = jtrans("Noxious gasses pour from your @hands@!");
            ...
            break;
        case 2:
            you_msg        = jtrans("You are under the weather.");
    ...
    case 2:         // much less harmless stuff
        ...
        {
        case 0:
            you_msg        = jtrans("You are caught in an explosion of electrical discharges!");
            mon_msg_seen   = "@The_monster@ is caught in an explosion of "
            ...
            break;
        case 1:
            you_msg        = jtrans("Venomous gasses pour from your @hands@!");
    ...
    case 3:         // even less harmless stuff
        ...
        case 0:
            if (_create_monster(MONS_BALL_LIGHTNING, 3))
                all_msg = jtrans("A ball of electricity appears!");
            do_msg();
            break;
        case 1:
            you_msg        = jtrans("The air twists around and strikes you!");
        ...
        case 2:
            if (_create_monster(MONS_TWISTER, 1))
                all_msg = jtrans("A huge vortex of air appears!");
            do_msg();
            break;
        }
        break;
...
void MiscastEffect::_poison(int severity)
{
    ...
    case 0:         // just a harmless message
        ...
        {
        case 0:
            you_msg      = jtrans("You feel mildly nauseous.");
            mon_msg_seen = "@The_monster@ briefly looks nauseous.";
            break;
        case 1:
            you_msg      = jtrans("You feel slightly ill.");
            mon_msg_seen = "@The_monster@ briefly looks sick.";
            break;
        case 2:
            you_msg      = jtrans("Wisps of poison gas drift from your @hands@.");
        ...
        case 3:
            ...
            break;
        case 4:
            you_msg      = jtrans("You feel faint for a moment.");
            mon_msg_seen = "@The_monster@ looks faint for a moment.";
            break;
        case 5:
            you_msg      = jtrans("You feel sick.");
            mon_msg_seen = "@The_monster@ looks sick.";
            break;
        case 6:
            you_msg      = jtrans("You feel odd.");
            mon_msg_seen = "@The_monster@ has an odd expression for a "
                           "moment.";
            break;
        case 7:
            you_msg      = jtrans("You feel weak for a moment.");
        ...
        case 8:
            ...
            break;
        case 9:
            you_msg        = jtrans("Your vision is briefly tinged with green.");
    ...
    case 2:         // rather less harmless stuff
        ...
        case 0:
            if (target->res_poison() <= 0)
            {
                you_msg      = jtrans("You feel very sick.");
    ...
    case 3:         // less harmless stuff
        ...
        case 0:
            if (target->res_poison() <= 0)
            {
                you_msg      = jtrans("You feel incredibly sick.");
...
void MiscastEffect::_zot()
{
    ...
    case 0:    // mainly explosions
        ...
        case 0:
        case 1:
            all_msg = jtrans("There is a sudden explosion of flames!");
            beam.flavour = BEAM_FIRE;
            beam.colour  = RED;
            _explosion();
            break;
        case 2:
        case 3:
            all_msg = jtrans("There is a sudden explosion of frost!");
            beam.flavour = BEAM_COLD;
            beam.colour  = WHITE;
            _explosion();
            break;
        case 4:
            all_msg = jtrans("There is a sudden blast of acid!");
    ...
    reroll_1:
        ...
        case 7:
            ...
            if (success)
            {
                all_msg = jtrans("Wisps of shadow whirl around...");
                do_msg();
            }
            break;
        case 8:
    ...
    reroll_2:
        ...
        case 10:
            ...
            break;
//Fixme_ja_need_test_drainwandmp
        case 11:
        {
            vector<string> wands;
            ...
            if (!wands.empty())
                mpr_comma_separated_list(jtrans("Magical energy is drained from your %s"), wands);
            else
