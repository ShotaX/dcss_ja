...
static void _construct_game_modes_menu(MenuScroller* menu)
{
    ...
    tmp->set_description_text(jtrans("Me1"));
    ...
    // item height obtained from max.y - min.y
    tmp->set_bounds(coord_def(1, 1), coord_def(1, 2));
    tmp->set_description_text(jtrans("Me2"));
    menu->attach_item(tmp);
    tmp->set_visible(true);
    ...
    // item height obtained from max.y - min.y
    tmp->set_bounds(coord_def(1, 1), coord_def(1, 2));
    tmp->set_description_text(jtrans("Me3"));
    menu->attach_item(tmp);
    tmp->set_visible(true);
    ...
    // item height obtained from max.y - min.y
    tmp->set_bounds(coord_def(1, 1), coord_def(1, 2));
    tmp->set_description_text(jtrans("Me4"));
    menu->attach_item(tmp);
    tmp->set_visible(true);
    ...
    // item height obtained from max.y - min.y
    tmp->set_bounds(coord_def(1, 1), coord_def(1, 2));
    tmp->set_description_text(jtrans("Me5"));
    menu->attach_item(tmp);
    tmp->set_visible(true);
    ...
    // item height obtained from max.y - min.y
    tmp->set_bounds(coord_def(1, 1), coord_def(1, 2));
    tmp->set_description_text(jtrans("Me6"));
    menu->attach_item(tmp);
    tmp->set_visible(true);
    ...
    // item height obtained from max.y - min.y
    tmp->set_bounds(coord_def(1, 1), coord_def(1, 2));
    tmp->set_description_text(jtrans("Me7"));
    menu->attach_item(tmp);
    tmp->set_visible(true);
    ...
    // item height obtained from max.y - min.y
    tmp->set_bounds(coord_def(1, 1), coord_def(1, 2));
    tmp->set_description_text(jtrans("Me8"));
    menu->attach_item(tmp);
    tmp->set_visible(true);
}
