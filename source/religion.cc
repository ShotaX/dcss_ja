...
string get_god_likes(god_type which_god, bool verbose)
{
    ...
    {
    case GOD_SIF_MUNA:
        likes.push_back(jtrans("you train your various spell casting skills").c_str());
        break;

    case GOD_FEDHAS:
        snprintf(info, INFO_SIZE, jtrans("you promote the decay of nearby corpses%s").c_str(),
                 verbose ? jtrans("by praying").c_str() : "");
        likes.push_back(info);
        break;

    case GOD_TROG:
        snprintf(info, INFO_SIZE, jtrans("you destroy spellbooks%s1").c_str(),
                 verbose ? jtrans("via the <w>a</w> command").c_str() : "");
        likes.push_back(info);
        break;

    case GOD_NEMELEX_XOBEH:
        snprintf(info, INFO_SIZE, jtrans("you draw unmarked cards and use up decks%s").c_str(),
                 verbose ? jtrans("(by <w>w</w>ielding and e<w>v</w>oking them)").c_str()
                         : "");
    ...
    case GOD_ELYVILON:
        snprintf(info, INFO_SIZE, jtrans("you destroy weapons (especially unholy and evil ones)%s").c_str(),
                 verbose ? jtrans("via the <w>p</w> command (inscribe items with <w>!p</w> to prevent their accidental destruction)").c_str()
                         : "");
        likes.push_back(info);
        likes.push_back(jtrans("you calm hostilities by healing your foes").c_str());
        break;

    case GOD_JIYVA:
        snprintf(info, INFO_SIZE, jtrans("you sacrifice items%s").c_str(),
                 verbose ? jtrans("by allowing slimes to consume them").c_str() : "");
        likes.push_back(info);
        break;

    case GOD_CHEIBRIADOS:
        snprintf(info, INFO_SIZE, jtrans("you kill fast things%s").c_str(),
                 verbose ? jtrans(", relative to your speed").c_str()
                         : "");
        likes.push_back(info);
        break;

    case GOD_ASHENZARI:
        likes.push_back(jtrans("you explore the world (preferably while bound by curses)").c_str());
        break;

    case GOD_SHINING_ONE:
        likes.push_back(jtrans("you meet creatures to determine whether they need to be eradicated").c_str());
        break;

    case GOD_LUGONU:
        likes.push_back(jtrans("you banish creatures to the Abyss").c_str());
        break;
    ...
    {
    case GOD_ZIN:
        snprintf(info, INFO_SIZE, jtrans("you donate money%s").c_str(),
                 verbose ? jtrans("(by <w>p</w>raying at an altar)").c_str() : "");
        likes.push_back(info);
        break;

    case GOD_BEOGH:
        snprintf(info, INFO_SIZE, jtrans("you bless dead orcs%s").c_str(),
                 verbose ? jtrans("(by standing over their remains and <w>p</w>raying)").c_str() : "");
    ...
    case GOD_NEMELEX_XOBEH:
        snprintf(info, INFO_SIZE, jtrans("you sacrifice items%s").c_str(),
                 verbose ? jtrans("(by standing over them and <w>p</w>raying)").c_str() : "");
        likes.push_back(info);
        break;
    ...
    {
        snprintf(info, INFO_SIZE, jtrans("you sacrifice fresh corpses%s").c_str(),
                 verbose ? jtrans("(by standing over them and <w>p</w>raying)").c_str() : "");
    ...
    case GOD_MAKHLEB:
    case GOD_LUGONU:
        likes.push_back(jtrans("you or your allies kill living beings").c_str());
        break;

    case GOD_TROG:
        likes.push_back(jtrans("you or your god-given allies kill living beings").c_str());
        break;

    case GOD_YREDELEMNUL:
    case GOD_KIKUBAAQUDGHA:
        likes.push_back(jtrans("you or your undead slaves kill living beings").c_str());
        break;

    case GOD_BEOGH:
        likes.push_back(jtrans("you or your allied orcs kill living beings").c_str());
        break;

    case GOD_OKAWARU:
    case GOD_VEHUMET:
        likes.push_back(jtrans("you kill living beings").c_str());
        break;
    ...
    {
    case GOD_ZIN:
        likes.push_back(jtrans("you or your allies kill unclean or chaotic beings").c_str());
        break;

    case GOD_SHINING_ONE:
        likes.push_back(jtrans("you or your allies kill living unholy or evil beings").c_str());
        break;
    ...
    case GOD_MAKHLEB:
    case GOD_LUGONU:
        likes.push_back(jtrans("you or your allies kill the undead").c_str());
        break;

    case GOD_BEOGH:
        likes.push_back(jtrans("you or your allied orcs kill the undead").c_str());
        break;

    case GOD_OKAWARU:
    case GOD_VEHUMET:
        likes.push_back(jtrans("you kill the undead").c_str());
        break;
    ...
    case GOD_MAKHLEB:
    case GOD_LUGONU:
        likes.push_back(jtrans("you or your allies kill demons").c_str());
        break;

    case GOD_TROG:
        likes.push_back(jtrans("you or your god-given allies kill demons").c_str());
        break;

    case GOD_KIKUBAAQUDGHA:
        likes.push_back(jtrans("you or your undead slaves kill demons").c_str());
        break;

    case GOD_BEOGH:
        likes.push_back(jtrans("you or your allied orcs kill demons").c_str());
        break;

    case GOD_OKAWARU:
    case GOD_VEHUMET:
        likes.push_back(jtrans("you kill demons").c_str());
        break;
    ...
    {
    case GOD_YREDELEMNUL:
        likes.push_back(jtrans("you or your undead slaves kill artificial beings").c_str());
        break;
    ...
    case GOD_MAKHLEB:
    case GOD_LUGONU:
        likes.push_back(jtrans("you or your allies kill holy beings").c_str());
        break;

    case GOD_TROG:
        likes.push_back(jtrans("you or your god-given allies kill holy beings").c_str());
        break;

    case GOD_YREDELEMNUL:
        likes.push_back(jtrans("your undead slaves kill holy beings").c_str());
        likes.push_back(jtrans("you desecrate holy remains").c_str());
        break;

    case GOD_KIKUBAAQUDGHA:
        likes.push_back(jtrans("you or your undead slaves kill holy beings").c_str());
        break;

    case GOD_BEOGH:
        likes.push_back(jtrans("you or your allied orcs kill holy beings").c_str());
        break;

    case GOD_OKAWARU:
    case GOD_VEHUMET:
        likes.push_back(jtrans("you kill holy beings").c_str());
        break;
    ...
    {
    case GOD_YREDELEMNUL:
        really_likes.push_back(jtrans("you kill holy beings").c_str());
        break;

    case GOD_BEOGH:
        really_likes.push_back(jtrans("you kill the priests of other religions").c_str());
        break;

    case GOD_TROG:
        really_likes.push_back(jtrans("you kill wizards and other users of magic").c_str());
        break;
    ...
    else
    {
        ...
        if (!really_likes.empty())
        {
            ...
            text += jtrans("especially likes it when");
			text += "\n";
...
string get_god_dislikes(god_type which_god, bool /*verbose*/)
{
    ...
    if (god_hates_cannibalism(which_god))
        really_dislikes.push_back(jtrans("you perform cannibalism").c_str());

    if (is_good_god(which_god))
    {
        really_dislikes.push_back(jtrans("you desecrate holy remains").c_str());

        if (which_god == GOD_SHINING_ONE)
            really_dislikes.push_back(jtrans("you drink blood").c_str());
        else
            dislikes.push_back(jtrans("you drink blood").c_str());

        really_dislikes.push_back(jtrans("you use necromancy").c_str());
        really_dislikes.push_back(jtrans("you use unholy magic or items").c_str());
        really_dislikes.push_back(jtrans("you attack non-hostile holy beings").c_str());
        really_dislikes.push_back(jtrans("you or your allies kill non-hostile holy beings").c_str());

        if (which_god == GOD_ZIN)
            dislikes.push_back(jtrans("you attack neutral beings").c_str());
        else
            really_dislikes.push_back(jtrans("you attack neutral beings").c_str());
    }
    ...
    case GOD_OKAWARU:
        really_dislikes.push_back(jtrans("you attack allies").c_str());
        break;

    case GOD_BEOGH:
        really_dislikes.push_back(jtrans("you attack allied orcs").c_str());
        break;

    case GOD_JIYVA:
        really_dislikes.push_back(jtrans("you attack fellow slimes").c_str());
        break;

    case GOD_FEDHAS:
        dislikes.push_back(jtrans("you or your allies destroy plants").c_str());
        dislikes.push_back(jtrans("allied flora die").c_str());
        really_dislikes.push_back(jtrans("you use necromancy on corpses, chunks or skeletons").c_str());
        break;

    case GOD_SIF_MUNA:
        really_dislikes.push_back(jtrans("you destroy spellbooks").c_str());
        break;
    ...
    case GOD_ELYVILON: case GOD_OKAWARU:
        dislikes.push_back(jtrans("you allow allies to die").c_str());
        break;

    case GOD_ZIN:
        dislikes.push_back(jtrans("you allow sentient allies to die").c_str());
        break;
    ...
    {
    case GOD_ZIN:
        dislikes.push_back(jtrans("you deliberately mutate yourself").c_str());
        really_dislikes.push_back(jtrans("you transform yourself").c_str());
        really_dislikes.push_back(jtrans("you polymorph monsters").c_str());
        really_dislikes.push_back(jtrans("you use unclean or chaotic magic or items").c_str());
        really_dislikes.push_back(jtrans("you eat the flesh of sentient beings").c_str());
        dislikes.push_back(jtrans("you or your allies attack monsters in a sanctuary").c_str());
        break;

    case GOD_SHINING_ONE:
        really_dislikes.push_back(jtrans("you poison monsters").c_str());
        really_dislikes.push_back(jtrans("you attack intelligent monsters in an unchivalric manner").c_str());
        break;

    case GOD_ELYVILON:
        really_dislikes.push_back(jtrans("you kill living things while asking for your life to be spared").c_str());
        break;

    case GOD_YREDELEMNUL:
        really_dislikes.push_back(jtrans("you use holy magic or items").c_str());
        break;

    case GOD_TROG:
        really_dislikes.push_back(jtrans("you memorise spells").c_str());
        really_dislikes.push_back(jtrans("you attempt to cast spells").c_str());
        really_dislikes.push_back(jtrans("you train magic skills").c_str());
        break;

    case GOD_BEOGH:
        really_dislikes.push_back(jtrans("you desecrate orcish remains").c_str());
        really_dislikes.push_back(jtrans("you destroy orcish idols").c_str());
        break;

    case GOD_JIYVA:
        really_dislikes.push_back(jtrans("you kill slimes").c_str());
        break;

    case GOD_CHEIBRIADOS:
        really_dislikes.push_back(jtrans("you hasten yourself or others").c_str());
        really_dislikes.push_back(jtrans("use unnaturally quick items").c_str());
        break;
    ...
    {
        text += uppercase_first(god_name(which_god));
        text += jtrans("strongly dislikes it when");
        text += "\n";
...
void dec_penance(god_type god, int val)
{
    ...
    if (you.penance[god] <= val)
    {
        ...
        simple_god_message(
            make_stringf(jtrans("seems mollified%s.").c_str(),
                         dead_jiyva ? jtrans(", and vanishes").c_str() : "").c_str(),
            god);
        ...
        if (you_worship(god))
        {
            ...
            {
                mpr(jtrans("Your divine halo returns!"));
                invalidate_agrid(true);
            }
            else if (god == GOD_ASHENZARI
                     && you.piety >= piety_breakpoint(2))
            {
                mpr(jtrans("Your vision regains its divine sight."));
                autotoggle_autopickup(false);
            }
            else if (god == GOD_CHEIBRIADOS)
            {
                simple_god_message(jtrans("restores the support of your attributes.").c_str());
                redraw_screen();
    ...
    { // Nemelex's penance works actively only until 100
        ...
        simple_god_message(jtrans("seems mollified... mostly.").c_str(), god);
        take_note(Note(NOTE_MOLLIFY_GOD, god));
    }
    else
        you.penance[god] -= val;
...
static void _inc_penance(god_type god, int val)
{
    ...
    if (!player_under_penance(god))
    {
        ...
        {
            if (you.haloed())
                mpr(jtrans("Your divine halo fades away."));
                    ...
                    bool force)
{
        ...
        if (!follower)
        {
            ...
            if (!follower)
            {
                ...
                if (!follower)
                {
                    ...
                    _delayed_monster_done(jtrans("Beogh blesses you with reinforcements.").c_str(), "");
    ...
    if (chance <= 1 && god == GOD_BEOGH) // 10% chance of priesthood
    {
        ...
        if (_beogh_blessing_priesthood(follower))
        {
            ...
            mpr(jtrans("Couldn't promote monster to priesthood."));
    }
    ...
    if (chance <= 1)
    {
        if (coinflip())
        {
            if (_blessing_wpn(follower))
            {
                ...
                mpr(jtrans("Couldn't enchant monster's weapon."));
        }
        else
        {
            if (_blessing_AC(follower))
            {
                ...
                mpr(jtrans("Couldn't enchant monster's armour."));
        }
    }
    ...
    switch (god)
    {
        case GOD_SHINING_ONE:
        {
            ...
            if (force)
                mpr(jtrans("Couldn't increase monster's friendliness or time."));
        }
        ...
        case GOD_BEOGH:
        {
            ...
            if (coinflip())
            {
                if (_blessing_balms(follower))
                {
                    ...
                    mpr(jtrans("Couldn't apply balms."));
            }
            ...
            if (healing)
            {
                ...
                mpr(jtrans("Couldn't heal monster."));
...
blessing_done:
    ...
    simple_god_message(
        make_stringf(jtrans("blesses %s with %s.").c_str(),
...
{
    simple_god_message(jtrans("alters your body.").c_str());
...
void dock_piety(int piety_loss, int penance)
{
    ...
    if (piety_loss)
    {
        if (last_piety_lecture != you.num_turns)
        {
            ...
            mprf(jtrans("You feel%sguilty.").c_str(),
                 (piety_loss == 1) ? jtrans("a little").c_str() :
                 (piety_loss <  5) ? " " :
                 (piety_loss < 10) ? jtrans("very").c_str()
                                   : jtrans("extremely").c_str());
        }
    ...
    else if (penance)       // only if still in religion
    {
        ...
        {
            god_speaks(you.religion,
                       jtrans("\"You will pay for your transgression, mortal!\"").c_str());
        }
...
static void _gain_piety_point()
{
    ...
    for (int i = 0; i < MAX_GOD_ABILITIES; ++i)
    {
            ...
            && old_piety < piety_breakpoint(i))
        {
            ...
            if (_abil_chg_message(jtrans(god_gain_power_messages[you.religion][i]).c_str(),
                                  jtrans("You can now %s.").c_str(), i))
            {
            ...
            if (you_worship(GOD_SHINING_ONE) && i == 0)
                mpr(jtrans("A divine halo surrounds you!"));
    ...
    {
        simple_god_message(jtrans("raises the support of your attributes as your movement slows.").c_str());
    ...
    if (you.piety >= piety_breakpoint(5) && old_piety < piety_breakpoint(5))
    {
        ...
        if (!you.one_time_ability_used[you.religion])
        {
            ...
            {
                case GOD_ZIN:
                    simple_god_message(jtrans("will now cure all your mutations... once.").c_str());
                    break;
                case GOD_SHINING_ONE:
                    if (you.species == SP_FELID)
                        break;
                    simple_god_message(jtrans("will now bless your weapon at an altar... once.").c_str());
                    break;
                case GOD_KIKUBAAQUDGHA:
                    simple_god_message(jtrans("will now enhance your necromancy at an altar... once.").c_str());
                    break;
                case GOD_LUGONU:
                    if (you.species == SP_FELID)
                        break;
                    simple_god_message(jtrans("will now corrupt your weapon at an altar... once.").c_str());
                    break;
                case GOD_JIYVA:
                    simple_god_message(jtrans("will now unseal the treasures of the Slime Pits.").c_str());
...
void lose_piety(int pgn)
{
    ...
    if (!player_under_penance() && you.piety != old_piety)
    {
            ...
            && !you.one_time_ability_used[you.religion])
        {
            ...
            {
                simple_god_message(
                    jtrans("is no longer ready to cure all your mutations.").c_str());
            }
            else if (you_worship(GOD_SHINING_ONE) && you.species != SP_FELID)
            {
                simple_god_message(
                    jtrans("is no longer ready to bless your weapon.").c_str());
            }
            else if (you_worship(GOD_KIKUBAAQUDGHA))
            {
                simple_god_message(
                    jtrans("is no longer ready to enhance your necromancy.").c_str());
            }
            else if (you_worship(GOD_LUGONU) && you.species != SP_FELID)
            {
                simple_god_message(
                    jtrans("is no longer ready to corrupt your weapon.").c_str());
            }
        }
        ...
        for (int i = 0; i < MAX_GOD_ABILITIES; ++i)
        {
                ...
                && old_piety >= piety_breakpoint(i))
            {
                ...
                lose_god_ability(i);
                _abil_chg_message(jtrans(god_lose_power_messages[you.religion][i]).c_str(),
                                  jtrans("You can no longer %s.").c_str(), i);
    ...
    if (you_worship(GOD_CHEIBRIADOS)
        && chei_stat_boost(old_piety) > chei_stat_boost())
    {
        simple_god_message(jtrans("reduces the support of your attributes as your movement quickens.").c_str());
...
void excommunication(god_type new_god)
{
    ...
    case GOD_KIKUBAAQUDGHA:
        mpr(jtrans("You sense decay.")); // in the state of Denmark?
    ...
    case GOD_BEOGH:
        ...
        if (query_da_counter(DACT_ALLY_BEOGH))
        {
            ...
            mpr(jtrans("All of your followers decide to abandon you."),
    ...
    case GOD_JIYVA:
        ...
        {
            mpr(jtrans("All of your fellow slimes turn on you."),
                MSGCH_MONSTER_ENCHANT);
    ...
    case GOD_FEDHAS:
        ...
        {
            mpr(jtrans("The plants of the dungeon turn on you."),
                MSGCH_MONSTER_ENCHANT);
    ...
    {
        mpr(jtrans("The divine host forsakes you."), MSGCH_MONSTER_ENCHANT);
        add_daction(DACT_ALLY_HOLY);
    }
                             ...
                             piety_gain_t piety_gain, bool your)
{
    if (god == GOD_ELYVILON && get_weapon_brand(item) == SPWPN_HOLY_WRATH)
    {
        ...
        simple_god_message(
            make_stringf(jtrans("%sreclaims %s.").c_str(),
                         piety_gain ? jtrans("gladly").c_str() : "",
                         item.name(DESC_THE).c_str()).c_str(),
            GOD_SHINING_ONE);
        return;
    }
    const string itname = item.name(your ? DESC_YOUR : DESC_THE);
    mpr(_sacrifice_message(jtrans(_Sacrifice_Messages[god][piety_gain]).c_str(), itname,
...
void nemelex_death_message()
{
    ...
    mpr(_sacrifice_message(_Sacrifice_Messages[GOD_NEMELEX_XOBEH][piety_gain],
                           jtrans("Your body").c_str(), you.backlit(), false, piety_gain));
}
...
static void _god_welcome_identify_gear()
{
    ...
    if (amulet && amulet->sub_type == AMU_FAITH)
    {
        ...
        mpr(jtrans("Your amulet flashes!"), MSGCH_GOD);
...
void god_pitch(god_type which_god)
{
    ...
    {
    mprf(jtrans("You %s the altar of %s.").c_str(),god_name(which_god).c_str(),
         you.form == TRAN_WISP   ? jtrans("swirl around").c_str() :
         you.form == TRAN_BAT    ? jtrans("perch on").c_str() :
         you.flight_mode()       ? jtrans("hover solemnly before").c_str() :
         you.form == TRAN_SPIDER ? jtrans("cling to").c_str() :
         you.form == TRAN_STATUE ? jtrans("place yourself before").c_str() :
         you.form == TRAN_ICE_BEAST
             || you.form == TRAN_DRAGON
             || you.form == TRAN_PIG    ? jtrans("bow your head before").c_str() :
         you.form == TRAN_TREE   ? jtrans("sway towards").c_str() :
         you.form == TRAN_FUNGUS ? jtrans("release spores on").c_str() :
         you.form == TRAN_PORCUPINE ? jtrans("curl into a sanctuary of spikes before").c_str() :
         you.form == TRAN_JELLY  ? jtrans("quiver devoutly before").c_str() :
         you.species == SP_NAGA  ? jtrans("coil in front of").c_str() :
         // < TGWi> you curl up on the altar and go to sleep
         you.species == SP_FELID ? jtrans("sit before").c_str() :
         // duplicated because of forms
         you.species == SP_DJINNI ? jtrans("hover solemnly before").c_str() :
                                    jtrans("kneel at").c_str());
    }
    more();
    ...
    if (!player_can_join_god(which_god))
    {
        ...
        {
            simple_god_message(jtrans("says: How dare you come in such a loathsome form!").c_str(),
                               which_god);
        }
        else
        {
            simple_god_message(jtrans("does not accept worship from those such as you!").c_str(),
                               which_god);
        }
        return;
    }
    ...
    snprintf(info, INFO_SIZE, jtrans("Do you wish to %sjoin this religion?").c_str(),
             (you.worshipped[which_god]) ? jtrans("re").c_str() : "");
    ...
    simple_god_message(
        make_stringf(jtrans("welcomes you%s!").c_str(),
                     you.worshipped[which_god] ? jtrans("back").c_str() : "").c_str());
    more();
    ...
    if (you_worship(GOD_CHEIBRIADOS))
    {
        simple_god_message(jtrans("begins to support your attributes as your movement slows.").c_str());
    ...
    {
        mpr(jtrans("Your demonic guardian will not assist you as long as you worship Okawaru."), MSGCH_GOD);
    }
        ...
        && query_da_counter(DACT_ALLY_UNHOLY_EVIL))
    {
        ...
        mpr(jtrans("Your unholy and evil allies forsake you."), MSGCH_MONSTER_ENCHANT);
    }
        ...
        && query_da_counter(DACT_ALLY_UNCLEAN_CHAOTIC))
    {
        ...
        mpr(jtrans("Your unclean and chaotic allies forsake you."),
            MSGCH_MONSTER_ENCHANT);
    }
             ...
             && query_da_counter(DACT_ALLY_SPELLCASTER))
    {
        ...
        mpr(jtrans("Your magic-using allies forsake you."), MSGCH_MONSTER_ENCHANT);
    }

    if (you_worship(GOD_ELYVILON))
    {
        mpr(jtrans("You can now call upon Elyvilon to destroy weapons lying on the ground."), MSGCH_GOD);
        mpr(jtrans("You can now provide lesser healing for others."), MSGCH_GOD);
    }
    else if (you_worship(GOD_TROG))
    {
        mpr(jtrans("You can now call upon Trog to burn spellbooks in your surroundings."), MSGCH_GOD);
    }
    else if (you_worship(GOD_FEDHAS))
    {
        mpr(jtrans("You can now call upon Fedhas to speed up the decay of corpses."),
            MSGCH_GOD);
        mpr(jtrans("The plants of the dungeon cease their hostilities."),
            MSGCH_MONSTER_ENCHANT);
    ...
    if (is_good_god(you.religion) && is_good_god(old_god))
    {
        ...
        {
        case GOD_ELYVILON:
            simple_god_message((jtrans("says:").c_str()
                               + god_name(you.religion) + jtrans("Farewell. Go and aid the meek with").c_str()).c_str(), old_god);
            break;
        case GOD_SHINING_ONE:
            simple_god_message((jtrans("says:").c_str()
                               + god_name(you.religion) + jtrans("Farewell. Go and vanquish evil with").c_str()).c_str(), old_god);
            break;
        case GOD_ZIN:
            simple_god_message((jtrans("says:").c_str()
                               + god_name(you.religion) + jtrans("Farewell. Go and enforce order with").c_str()).c_str(), old_god);
            break;
        default:
        ...
        && god_hates_your_god(GOD_ZIN, you.religion))
    {
        simple_god_message(make_stringf(jtrans("says: You will suffer for embracing such %s!").c_str(),
                                        is_chaotic_god(you.religion) ? jtrans("chaos").c_str() : jtrans("evil").c_str()).c_str(),
                           GOD_ZIN);
    }
