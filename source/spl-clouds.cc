...
spret_type conjure_flame(int pow, const coord_def& where, bool fail)
{
    ...
    if (cell_is_solid(where))
    {
        ...
        case DNGN_METAL_WALL:
            mpr(jtrans("You can't ignite solid metal!"));
            break;
        case DNGN_GREEN_CRYSTAL_WALL:
            mpr(jtrans("You can't ignite solid crystal!"));
            break;
        case DNGN_TREE:
        case DNGN_MANGROVE:
            fail_check();
        ...
        default:
            mpr(jtrans("You can't ignite solid rock!"));
            break;
        }
        return SPRET_ABORT;
    }
                      ...
                      bool fail)
{
    ...
    {
        mpr(jtrans("You can't place clouds on a wall."));
        return SPRET_ABORT;
    }
...
spret_type cast_ring_of_flames(int power, bool fail)
{
    ...
    {
        mpr(jtrans("Your spell sizzles in the rain."));
        return SPRET_ABORT;
    }
...
void manage_fire_shield(int delay)
{
    ...
    {
        mpr(jtrans("Your ring of flames gutters out."), MSGCH_DURATION);
        return;
    }
    ...
    if (old_dur > threshold && you.duration[DUR_FIRE_SHIELD] < threshold)
        mpr(jtrans("Your ring of flames is guttering out."), MSGCH_WARN);
